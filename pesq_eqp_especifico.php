...
<strong><span>Pesquisa de total de equipamentos</span></strong><br><br>
...
$sql = mysql_query ("select * from patrimonio where equip = '$eqp' and uf = '$uf'  ORDER BY tecnico asc" );
...
$sql3 =  mysql_query ("select count(*)  as conta from patrimonio where equip = '$eqp' and uf = '$uf' " );
