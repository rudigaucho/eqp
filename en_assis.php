...
$query = "update patrimonio join status on patrimonio.patrimonio = status.id_patrimonio set patrimonio.status_equip = '6', status.data_envio_assis = NOW() where status.protocolo = '$pt'";
