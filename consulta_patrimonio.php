...
<form class="form-inline" role="form"  method="POST" action="consulta_patrimonio.php"  style="margin-left:10%;">
...
{
$busca = $_POST['nome'];
$sql = mysql_query ("select * from patrimonio where patrimonio = '".$busca."'" );
