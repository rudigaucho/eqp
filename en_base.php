...
$query = "update patrimonio join status on patrimonio.patrimonio = status.id_patrimonio set patrimonio.status_equip = '9', status.data_retorno_base = NOW() where status.protocolo = '$pt'";
