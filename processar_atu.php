 ...
 <form class="form" id="form" role="form" name="seachform" method="post" action="enviar_atu.php " enctype="multipart/form-data" >
    ...
    <img src="loading.gif" id="loading" style="display:none; width:50px;height:50px;   " />
     ...
     <div class="form-group">
      ...
      <input type="text" class="form-control" id="id_tec" name="id_tec"  value="'.$lin_dado_cli['id_tec'].'" required>
    </div>
...
<div class="form-group">
      ...
      <input type="text" class="form-control" id="id_ga" name="id_ga"  value="'.$lin_dado_cli['id_ga'].'" required  >
    </div>
...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="eqp" name="eqp"    readonly value="'.$lin_dado_cli['equip'].'" required>
    </div>
     <div class="form-group">
