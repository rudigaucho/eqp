...
$query = "update patrimonio join status on patrimonio.patrimonio = status.id_patrimonio set patrimonio.status_equip = '8', status.data_retorno_assis = NOW() where status.protocolo = '$pt'";
