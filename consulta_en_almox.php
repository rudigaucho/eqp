...
<span><strong>CONSULTA EQP ENVIADO AO ALMOX</strong></span><br><br><br>
...
$sql = mysql_query ("select patrimonio.foto,status.protocolo,patrimonio,patrimonio.tecnico,patrimonio.ga,patrimonio.base,patrimonio.status_equip,patrimonio.equip,patrimonio.modelo from patrimonio join status on patrimonio.patrimonio = status.id_patrimonio where status_equip = 0   and data_recebimento_ga = '0000-00-00'" );
...
$sql3 =  mysql_query ("select  count(*) as conta from patrimonio where status_equip = 0" );
...
<div class="modal fade" id="myModal<?php echo $dado ['protocolo'];  ?>" role="dialog">
  ...
  <form role="form" name="seachform" method="post" action="conf_almox.php " >
