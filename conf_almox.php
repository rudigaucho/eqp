...
$query = "update patrimonio join status on patrimonio.patrimonio = status.id_patrimonio set patrimonio.status_equip = '1', status.data_recebimento_almox_cta = NOW() where status.protocolo = '$pt'";
