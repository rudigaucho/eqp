...
<strong><span>Pesquisa de equipamentos enviado ao almox </span></strong><br><br>
...
$data = $_POST['date'];
$data2 = $_POST['date2'];
$sql = mysql_query ("select status.protocolo,patrimonio.patrimonio,patrimonio.tecnico,patrimonio.equip,patrimonio.modelo,patrimonio.status_equip,status.data_envio_almox_cta,status.data_recebimento_almox_cta,status.data_envio_assis,data_retorno_assis from patrimonio join status on patrimonio.patrimonio = status.id_patrimonio where status_equip = 0 and data_recebimento_ga = '0000-00-00'  ORDER BY ga asc" );
...
$sql3 =  mysql_query ("select count(*)  as conta from patrimonio join status on patrimonio.patrimonio = status.id_patrimonio where status_equip = 0 and data_recebimento_ga = '0000-00-00' " );
