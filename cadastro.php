...
<div class="navbar navbar-inverse navbar">
        ...
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">Eqp pendentes</a></li>
          <li><a href="#">Eqp e status</a></li>
          <li><a href="#">Patrimonio</a></li>
         
         
        </ul>
      </li>
         <li class="active"><a href="#">Trocar senha</a></li>
...
<form class="form col-sm-10" role="form" name="seachform" method="post" id="form" action="enviar.php "  >
