...
<span><strong>CONSULTA POR TÉCNICO</strong></span><br><br><br>

<form class="form-inline" role="form"  method="POST" action="pes_adm_tec.php"  style="margin-left:10%;">
    <div class="form-group">
      <label for="email">Digite o id do Técnico</label>
...
{
$busca = $_POST['nome'];
$sql = mysql_query ("select * from patrimonio where id_tec = '".$busca."'" );
